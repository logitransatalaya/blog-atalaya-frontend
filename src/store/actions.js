...
// action - auth
export const AUTH_RECOVERY_LOADING = '@/auth/AUTH_RECOVERY_LOADING'
export const AUTH_RECOVERY_SUCCESS = '@/auth/AUTH_RECOVERY_SUCCESS'
export const AUTH_RECOVERY_ERROR = '@/auth/AUTH_RECOVERY_ERROR'
export const AUTH_RECOVERY_INITIALIZED = '@/auth/AUTH_RECOVERY_INITIALIZED'
